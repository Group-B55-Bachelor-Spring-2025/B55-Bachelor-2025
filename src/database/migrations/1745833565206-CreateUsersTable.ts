...
export class CreateUsersTable1745833565206 implements MigrationInterface {
  name = 'CreateUsersTable1745833565206';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'user', 'integrated_user')`,
    );
    await queryRunner.query(
